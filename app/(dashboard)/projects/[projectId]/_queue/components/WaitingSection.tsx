...
export function WaitingSection() {
  ...
  return (
    <>
          ...
          {isOwner && (
            <div className="flex items-center gap-2">
              <Button
                ...
                className="text-xs h-8 border-indigo-200 text-indigo-700 hover:bg-indigo-50 dark:border-indigo-800 dark:text-indigo-400"
              >
      ...
      {/* Import Excel Modal (portal-like, fixed overlay) */}
      {showImportModal && isOwner && (
        <ImportExcelModal project={project} projectRoles={projectRoles} />
      )}
    </>
  )
}
